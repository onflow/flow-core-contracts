...
/*
cd lib/go/test
cd ../contracts && make generate && cd ../templates && make generate && cd ../test && go test -timeout 30s github.com/onflow/lib/go/flow-core-contracts -run ^TestFlowArcadeToken$ -v
*/

...
require (
	...
	github.com/onflow/flow-ft/lib/go/contracts v0.7.1-0.20240122215608-fc1538d92763 // indirect
	github.com/onflow/flow-nft/lib/go/contracts v1.1.1-0.20240122215714-3c2b2d2c2e47 // indirect

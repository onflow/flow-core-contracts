...
require (
	...
	github.com/onflow/flow-ft/lib/go/templates v0.7.1-0.20240209175139-2ab8303b23b7
	github.com/onflow/flow-go-sdk v1.0.0-M1
	github.com/onflow/flow-nft/lib/go/templates v0.0.0-20240209175113-e3b2202ee7a7

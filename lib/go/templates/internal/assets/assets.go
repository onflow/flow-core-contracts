...
// epoch/admin/recover_epoch.cdc (2.135kB)
...
func epochAdminRecover_epochCdc() (*asset, error) {
	...
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x45, 0x45, 0x37, 0x2, 0xa6, 0x25, 0xe, 0x2f, 0x86, 0x21, 0xfe, 0x39, 0x66, 0x8f, 0xdb, 0xfd, 0x6f, 0x3b, 0xe1, 0xbe, 0x25, 0xd8, 0x90, 0x3d, 0xe2, 0xc5, 0x95, 0xfa, 0x74, 0xdc, 0xc5, 0xb2}}
	return a, nil
}

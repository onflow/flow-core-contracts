...
describe("ExecutionNodeVersionBeacon Contract Tests", () => {
     ...
     *  [X] - Delete version from table fails as it doesn't exist
     *  [X] - Change buffer within variance succeeds
     *  [X] - Change buffer outside of variance fails
    ...
    test("Change versionUpdateBuffer succeeds", async () => {
        // Contract initialization arguments

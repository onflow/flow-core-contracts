...
access(all) fun testScheduledTransactionCancelationLimits() {
    ...
    // The first 12 canceled transactions should have been removed from the canceled transactions array
    i = 13 as UInt64
